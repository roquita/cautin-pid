...
;initializer for _ki
	dw	(normalize32(0x3ba3d70a) & 0ffffh)
	dw	highword (normalize32(0x3ba3d70a))
...
; #config settings
	...
	config EBTR3 = "OFF"
	config EBTRB = "OFF"
	file	"dist/default/debug\test4550.X.debug.s"
	line	#
...
;!BANK1              100     43      9B       6       60.5%
;!BITBANK3            F4      0       0       9        0.0%
;!BANK3               F4      0       0      10        0.0%
;!BITBANK0            A0      0       0       3        0.0%
;!BANK0               A0     69      9E       4       98.8%
;!BITCOMRAM           5E      0       0       0        0.0%
;!COMRAM              5E     57      5B       1       96.8%
;!BITBIGSFR_1lh       21      0       0      26        0.0%
;!BITBIGSFRll         20      0       0      30        0.0%
;!BITBIGSFR_5h         A      0       0      19        0.0%
;!BITBIGSFR_1hl        8      0       0      25        0.0%
;!BITBIGSFRhl          8      0       0      29        0.0%
;!BITBIGSFRhhh         6      0       0      27        0.0%
;!BITBIGSFRhhll        5      0       0      28        0.0%
;!BITBIGSFR_1hh        4      0       0      24        0.0%
...
l5007:
;pid.c: 28:     float uk = uk1 + kp * (ek - ek1) + ki * (ek / 2.0f + ek1 / 2.0f) + kd * (ek + 2 * ek1 + ek2);
	movlw	low(normalize32(0x3ba3d70a))
	movwf	((c:___flmul@a))^00h,c
	movlw	high(normalize32(0x3ba3d70a))
	movwf	((c:___flmul@a+1))^00h,c
	movlw	low highword(normalize32(0x3ba3d70a))
	movwf	((c:___flmul@a+2))^00h,c
	movlw	high highword(normalize32(0x3ba3d70a))
	movwf	((c:___flmul@a+3))^00h,c
