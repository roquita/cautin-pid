	...
	; -Mdist/default/debug/test4550.X.debug.map -D__DEBUG=1 --debugger=none \
	; -DXPRJ_default=default -L--defsym=__MPLAB_BUILD=1 \
	; --dfp=C:/Program Files/Microchip/MPLABX/v6.10/packs/Microchip/PIC18Fxxxx_DFP/1.4.151/xc8 \
	; --double=32 --float=32 --emi=wordwrite --opt=+asmfile \
	...
	; --stack=compiled:auto:auto:auto --rom=default,-7dc0-7fff \
	; --ram=default,-3f4-3ff,-f9c-f9c,-fd4-fd4,-fdb-fdf,-fe3-fe7,-feb-fef,-ffd-fff \
	; --summary=+xml --summarydir=dist/default/debug/memoryfile.xml \
	; -otest4550.X.debug.elf --objdir=dist/default/debug \
	; --outdir=dist/default/debug build/default/debug/main.p1 \
	; build/default/debug/screen.p1 build/default/debug/software_uart.p1 \
	; build/default/debug/systimer.p1 build/default/debug/input_output.p1 \
	; build/default/debug/pid.p1 build/default/debug/interrupt_isr.p1 \
